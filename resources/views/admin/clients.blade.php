                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="{{ url('admin/clientdetail', ['uuid' => $item['uuid']])}}">{{ $item['email']}}</a>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td>
                        <div class="clearfix">
                          <div class="float-left mr-2">
                            <strong>
                              <form action="{{ route('page.clients.blockClient')}}" method="POST">
                                @csrf
                          ...
                          <div class="float-left mr-2">
                            <strong>
                              <form action="{{ route('page.clients.unblockClient')}}" method="POST">
                                @csrf
                                <input type="hidden" name="uuid" value="{{ $item['uuid'] }}">
                          ...
                          <div class="float-left mr-2">
                            <strong>
                              <form action="{{ route('page.clients.activateClient')}}" method="POST">
                                @csrf
                                <input type="hidden" name="uuid" value="{{ $item['uuid'] }}">
